    ...
    <div className={styles.container}>
      ...
      <div className={styles.container2}>
        <div className={styles.contactanos}>
          <h1 className={styles.cont}>Contactanos</h1>
          <input className={styles.correo} type="text" placeholder='Correo Electronico'/>
          <input className={styles.mensaje} type="text" placeholder='Mensaje'/>
